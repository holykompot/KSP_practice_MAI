...
print('Запуск произведен успешно!')
...
print('Отделение стартовой ступени!')
...
print('Парашют активен!')
vessel.control.activate_next_stage()

while vessel.flight(vessel.orbit.body.reference_frame).vertical_speed < -0.1:
    print('Высота составляет = %.1f метров' % vessel.flight().surface_altitude)
    time.sleep(1)
print('Посадка произведена успешно!')
